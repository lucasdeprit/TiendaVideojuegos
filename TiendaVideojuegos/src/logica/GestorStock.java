...
public class GestorStock implements SePuedeComprar {
	...
	public boolean sePuedeComprar(Cliente c, Viideojuego v) {
		// se comprueba que el cliente cumpla ciertos requisitos para comprar el
		// juego
	...
	public boolean sePuedeAlquilar(Cliente c) {
		// se comprueba que el cliente cumpla los requisitos minimos para poder
		// alquilar cierto juego
		// como pueden ser: Tener la suscripcion, tener la edad adecuada para el
		// juego,...
		return true;
